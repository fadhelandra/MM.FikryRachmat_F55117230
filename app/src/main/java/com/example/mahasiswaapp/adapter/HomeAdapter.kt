...
class HomeAdapter(private val context: Context, private val fakultasList: List<Fakultas>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (convertView == null) {
            view = LayoutInflater.from(context).inflate(R.layout.list_view_home, parent, false)
